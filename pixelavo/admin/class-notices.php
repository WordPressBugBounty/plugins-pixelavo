...
if ( ! class_exists( 'Pixelavo_Notice' ) ){
    class Pixelavo_Notice{
        ...
        public function ajax_dismiss() {
            ...
            $notice_id   = ( isset( $_POST['noticeid'] ) ) ? sanitize_key( wp_unslash( $_POST['noticeid'] ) ) : '';
            $alreadydid  = ( isset( $_POST['alreadydid'] ) ) ? sanitize_key( wp_unslash( $_POST['alreadydid'] ) ) : '';
            $expire_time = ( isset( $_POST['expiretime'] ) ) ? sanitize_text_field( wp_unslash( $_POST['expiretime'] ) ) : '';
            $close_by    = ( isset( $_POST['closeby'] ) ) ? sanitize_key( wp_unslash( $_POST['closeby'] ) ) : '';
        ...
        public function enqueue_scripts() {
            ...
            .pixelavo-admin-notice.promo-banner a {
                display: flex;
            }
            .pixelavo-admin-notice.promo-banner *:empty:not(img) {
                display: none;
            }
            .pixelavo-admin-notice.promo-banner .notice-dismiss {
                top: -10px;
                right: -10px;
            ...
            #pixelavo-notice-id-pixelavo-halloween-notice {
                padding: 12px;
                border-left-width: 1px;
            }
            #pixelavo-notice-id-pixelavo-halloween-notice .notice-dismiss {
                top: -10px;
                right: -10px;
                background-color: white;
                padding: 2px;
